...
import { Grid, Box, Typography, Button, FormControl, TextField, makeStyles } from "@material-ui/core";
    ...
    <Grid container className={classes.root}>
      ...
      <Grid container item className={classes.right} spacing={10}>
        <Grid container item className={classes.register} spacing={5}>
          ...
          <Button onClick={() => history.push("/register")} className={classes.registerButton} variant="contained" size="large">
            Register
          </Button>
        </Grid>
        <Grid container item>
